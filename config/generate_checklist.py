...
REFERENCES = {
    ...
    "enable_management_jumpbox": "https://learn.microsoft.com/azure/bastion/bastion-overview",
    "jumpbox_vm_size": "https://learn.microsoft.com/azure/virtual-machines/sizes",
    "bastion_sku": "https://learn.microsoft.com/azure/bastion/configuration-settings#skus",
...
decisions = [
    ...
    ("11o", "enable_cost_analysis",
        ...
        "true | false",
        "false  (true for regulated)"),
    ("11q", "enable_management_jumpbox",
        "Opt-in Azure Bastion + hardened no-public-IP jumpbox VM for private-cluster access (standalone only; ALZ hubs provide Bastion/VPN).",
        "true | false",
        "false"),
    ("11r", "jumpbox_vm_size",
        "VM size for the management jumpbox (any valid Azure VM size). Applies only when enable_management_jumpbox = true.",
        "Standard_B2s_v2 | Standard_D2s_v5 | any Azure VM size",
        "Standard_B2s_v2"),
    ("11s", "bastion_sku",
        "Azure Bastion SKU for jumpbox access. Standard enables native-client SSH/tunneling; Basic is browser-only. Applies only when enable_management_jumpbox = true.",
        "Standard | Basic",
        "Standard"),
